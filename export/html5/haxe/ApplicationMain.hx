...
class ApplicationMain {
	...
	private static function preload() {
		...
		loadFile("assets/images/bgs/bg1-2048.jpg");
		loadFile("assets/images/bgs/bg1.jpg");
		loadFile("assets/images/bgs/bg2-2048.jpg");
		loadFile("assets/images/bgs/bg2.jpg");
		loadFile("assets/images/bgs/bg3-2048.jpg");
		loadFile("assets/images/bgs/bg3.jpg");
		loadFile("assets/images/bgs/bg4-2048.jpg");
		loadFile("assets/images/bgs/bg4.jpg");
		loadFile("assets/images/buttons/back_button.png");
		loadFile("assets/images/buttons/back_button_small.png");
		loadFile("assets/images/buttons/pause_button.png");
		loadFile("assets/images/buttons/pause_button_small.png");
		loadFile("assets/images/buttons/play_button.png");
		loadFile("assets/images/buttons/play_button_small.png");
		loadFile("assets/images/buttons/reset_button.png");
		loadFile("assets/images/buttons/reset_button_small.png");
		loadFile("assets/images/circles/circle_black.png");
		loadFile("assets/images/circles/circle_cyan.png");
		loadFile("assets/images/circles/circle_magenta.png");
		loadFile("assets/images/circles/circle_yellow.png");
		loadFile("assets/images/preloader/loading.png");
		loadBinary("assets/music/music-goes-here.txt");
		loadSound("assets/sounds/ArpAA1.mp3");
		loadSound("assets/sounds/ArpAA1short.mp3");
		loadSound("assets/sounds/ArpAB1.mp3");
		loadSound("assets/sounds/ArpAB1short.mp3");
		loadSound("assets/sounds/ArpAD1.mp3");
		loadSound("assets/sounds/ArpAD1short.mp3");
		loadSound("assets/sounds/ArpAE1.mp3");
		loadSound("assets/sounds/ArpAE1short.mp3");
		loadSound("assets/sounds/ArpBA2.mp3");
		loadSound("assets/sounds/ArpBA3.mp3");
		loadSound("assets/sounds/ArpBB2.mp3");
		loadSound("assets/sounds/ArpBD1.mp3");
		loadSound("assets/sounds/ArpBD2.mp3");
		loadSound("assets/sounds/ArpBE1.mp3");
		loadSound("assets/sounds/ArpBE2.mp3");
		loadSound("assets/sounds/ArpBFS1.mp3");
		loadSound("assets/sounds/ArpBFS2.mp3");
		loadSound("assets/sounds/boopA2.mp3");
		loadSound("assets/sounds/boopA3.mp3");
		loadSound("assets/sounds/boopB2.mp3");
		loadSound("assets/sounds/boopD1.mp3");
		loadSound("assets/sounds/boopD2.mp3");
		loadSound("assets/sounds/boopE1.mp3");
		loadSound("assets/sounds/boopE2.mp3");
		loadSound("assets/sounds/boopFS1.mp3");
		loadSound("assets/sounds/boopFS2.mp3");
		loadSound("assets/sounds/hihat.mp3");
		loadSound("assets/sounds/kick1.mp3");
		loadSound("assets/sounds/kick2.mp3");
		loadSound("assets/sounds/snare1.mp3");
		loadBinary("assets/sounds/sounds-go-here.txt");
		loadSound("assets/sounds/voice0.mp3");
		loadSound("assets/sounds/voice1.mp3");
		loadSound("assets/sounds/voice2.mp3");
		loadSound("assets/sounds/voice3.mp3");
