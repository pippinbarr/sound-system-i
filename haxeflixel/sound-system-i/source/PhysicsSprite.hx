...
class PhysicsSprite extends FlxSprite
{
	...
	public function new(X:Float = 0, Y:Float = 0, Sprite:String, IsCircle:Bool, IsDynamic:Bool = false, Mass:Float = 1, Friction:Float = 0,
			Restitution:Float = 1, Width:Int = 0, Height:Int = 0)
	{
