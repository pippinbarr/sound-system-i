...
class ProtoState extends FlxState
{
	...
	override public function create():Void
	{
		...
		FlxG.camera.setBounds(0,0,FlxG.width*5,FlxG.height*3);
		...
		menuCamera2 = new FlxCamera(
			Std.int(FlxG.width/2),0,
			Std.int(FlxG.width),
			Std.int(FlxG.height),
			0.5);
		menuCamera2.focusOn(camera2FocusPoint);

		menuCamera3 = new FlxCamera(
			0,Std.int(FlxG.height/2),
			Std.int(FlxG.width),
			Std.int(FlxG.height),
			0.5);
		menuCamera3.focusOn(camera3FocusPoint);

		menuCamera4 = new FlxCamera(
	...
	private function createOne():Void
	{
		...
		oneCircle1 = new Circle(ORIGIN_X,ORIGIN_Y,ORIGIN_X + FlxG.width/2,ORIGIN_Y + FlxG.height/2,0,AssetPaths.circle_cyan__png,"",false,false,false);
	...
	private function createTwo():Void
	{
		...
		twoCircle1 = new Circle(ORIGIN_X,ORIGIN_Y,ORIGIN_X + 1*FlxG.width/3,ORIGIN_Y + FlxG.height/2,0,AssetPaths.circle_cyan__png,"assets/sounds/ArpB",false,true,true);
		twoCircle2 = new Circle(ORIGIN_X,ORIGIN_Y,ORIGIN_X + 2*FlxG.width/3,ORIGIN_Y + FlxG.height/2,0,AssetPaths.circle_magenta__png,"assets/sounds/ArpB",false,true,true);
	...
	private function createThree():Void
	{
		...
		threeCircle1 = new Circle(ORIGIN_X,ORIGIN_Y,ORIGIN_X + FlxG.width/4,ORIGIN_Y + FlxG.height/2,0,AssetPaths.circle_cyan__png,AssetPaths.kick1__mp3,true,false,false);
		threeCircle2 = new Circle(ORIGIN_X,ORIGIN_Y,ORIGIN_X + 2*FlxG.width/4,ORIGIN_Y + FlxG.height/2,0,AssetPaths.circle_magenta__png,AssetPaths.kick2__mp3,true,false,false);
		threeCircle3 = new Circle(ORIGIN_X,ORIGIN_Y,ORIGIN_X + 3*FlxG.width/4,ORIGIN_Y + FlxG.height/2,0,AssetPaths.circle_yellow__png,AssetPaths.snare1__mp3,true,false,false);
	...
	private function createFour():Void
	{
		...
		fourCircle1 = new Circle(ORIGIN_X,ORIGIN_Y,ORIGIN_X + FlxG.width/5,ORIGIN_Y + FlxG.height/2,0,AssetPaths.circle_cyan__png,"assets/sounds/boop",false,true,false);
		fourCircle2 = new Circle(ORIGIN_X,ORIGIN_Y,ORIGIN_X + 2*FlxG.width/5,ORIGIN_Y + FlxG.height/2,0,AssetPaths.circle_magenta__png,"assets/sounds/boop",false,true,false);
		fourCircle3 = new Circle(ORIGIN_X,ORIGIN_Y,ORIGIN_X + 3*FlxG.width/5,ORIGIN_Y + FlxG.height/2,0,AssetPaths.circle_yellow__png,"assets/sounds/boop",false,true,false);
		fourCircle4 = new Circle(ORIGIN_X,ORIGIN_Y,ORIGIN_X + 4*FlxG.width/5,ORIGIN_Y + FlxG.height/2,0,AssetPaths.circle_black__png,"assets/sounds/boop",false,true,false);
	...
	private function createButtons(OriginX:Float,OriginY:Float,ResetMethod:Dynamic,StopPlayMethod:Dynamic):Rectangle
	{
		...
		return new Rectangle(menuResetButton.x,menuResetButton.y,(menuStopPlayButton.x + menuStopPlayButton.width) - OriginX,(menuStopPlayButton.y + (menuStopPlayButton.height)) - OriginY);
	}
	 ...
	 */
	 ...
	 {	 	
	 	...
	 	{	 		
	 		...
	 		if (oneUIRect.containsPoint(new Point(FlxG.mouse.x,FlxG.mouse.y))) return;
	 		if (twoUIRect.containsPoint(new Point(FlxG.mouse.x,FlxG.mouse.y))) return;
	 		if (threeUIRect.containsPoint(new Point(FlxG.mouse.x,FlxG.mouse.y))) return;
	 		if (fourUIRect.containsPoint(new Point(FlxG.mouse.x,FlxG.mouse.y))) return;
